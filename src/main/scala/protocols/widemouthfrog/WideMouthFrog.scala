...
//
//                    if (new java.util.Date().getTime - decryptedMes.substring(0, decryptedMes.indexOf("B")).toLong > time)
//                      addMessage("Error")
//                    else {
//                      sessionKey = Integer.parseInt(decryptedMes.substring(new java.util.Date().getTime.toString.length))
...
//                        val Tb = new java.util.Date().getTime
//
//                        val sessionKey = decryptedMes.substring(30)
