...
//  }
//
//  def getOpenKey: PublicKey = {
//    PublicKey(rsa.getE, rsa.getN, rsa.getP, rsa.getQ)
//  }
//
//
//  def generateSessionKey(openKey: PublicKey): Int = {
//    new SecureRandom().nextInt(Math.abs(openKey.e.intValue() - 10)) + 1
//  }
//
//  def parseOpenKey(message: String): PublicKey = {
...
//  }
//
//  def setOpenKey(openKey: PublicKey): Unit = {
